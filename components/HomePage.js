  ...
  return (
    <>
      <View style={{flexDirection:'column',justifyContent:'space-around', alignItems:'center',backgroundColor:'lightblue'}}>
        ...
        <Text><i>You will start working towards your major in only few clicks! Start exploring!</i></Text>
      </View>
      ...
      <View style={{flex:2,flexDirection:'column'}}>
        <div style={{margin:'auto',
              margin: '28px 70px',textAlign: 'center'}}>
                  ...
                  <h1>Andrew Nguyen</h1>
                  <em><b></b></em>
                  <p>Hi everyone, I'm Andrew and I'm currently a sophomore majoring in Computer Science and Business at Brandeis University, USA. Every day, I love what I do and I am motivated to achieve my final goals. I enjoy self-studying and learning new technology to apply to projects. Programming opens many opportunities where I can satisfy my curiosity and create solutions for the community.</p>
